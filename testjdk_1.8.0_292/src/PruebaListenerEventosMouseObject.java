...
public class PruebaListenerEventosMouseObject {

    public static void main(String[] args){
        // Variables para la creación del Frame
        String titulo = new String("Ventana de Prueba de eventos del ratón y eventos de Mouse Listener");
        int width = 600;
        int height = 300;
        ...
        btHi.addMouseListener  (new ListenerEventosMouseObject());
        btBye.addMouseListener  (new ListenerEventosMouseObject());
    }
}
