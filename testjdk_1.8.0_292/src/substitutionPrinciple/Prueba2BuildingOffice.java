...
public class Prueba2BuildingOffice{
    ...
    static void printBuildings(List<Building> buildings){
        for (int i = 0; i < buildings.size(); i++){
            System.out.println("usando método printBuildings: " + "i+1: " + (i + 1) + ": " +  buildings.get(i).toString());
        }
    }
    ...
    public static void main(String[] args){
        ...
        // usando el método build(Building building) pasandole un objeto Building como parámetro
        ...
        // usando el método build(Building building) pasandole un objeto Office como parámetro porque office es un subtipo de building
        ...
        // adds some Building to a list of Building
            ...
            buildings.add(new Office()); // passes in the list to the method 
            // This is a substitution principle porque Office es un subtipo de Building
        ...
        /*
         * usando método printBuildings: i+1: 1: usando el método toString from class Building
		   usando método printBuildings: i+1: 2: usando el método toString from class Office
         */
...
/*
		...
		The method printBuildings(List<Building>) in the type PruebaBuildingOffice is not applicable for the arguments (List<Office>)
		at substitutionPrinciple.PruebaBuildingOffice.main(PruebaBuildingOffice.java:76)
*/
