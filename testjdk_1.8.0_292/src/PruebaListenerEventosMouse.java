...
public class PruebaListenerEventosMouse{

    public static void main(String[] args){
        // Variables para la creación del Frame
        String titulo = new String("Ventana de Prueba de TODOS los eventos del ratón");
        int width = 600;
        int height = 300;
        ...
        // ListenerMouse.java
        btHi.addMouseListener  (new ListenerEventosMouse());
        btBye.addMouseListener  (new ListenerEventosMouse());
    }
}
