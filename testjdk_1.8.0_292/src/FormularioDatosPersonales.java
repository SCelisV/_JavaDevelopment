...
// Si no se ubieran definido los métodos DatosPersonales, DatosPersonales y Ciudades en la clase formulario, pasandoles el panel como parámetro, se debería definir los Paneles del Formulario en la clase como private static Panel PnlFormulario = new Panel();

*/

import java.awt.*;

public class FormularioDatosPersonales {
    ...
    FormularioDatosPersonales(Color color){
