...
public class PruebaListenerEventosKeyAdapter {
    ...
    public static void main(String[] args){
        ...
        Button btn0 = new Button("Silent");
        Button btn1 = new Button("Máquina de escribir");
        ...
        btn1.addKeyListener(new ListenerEventosKeyAdapter());
